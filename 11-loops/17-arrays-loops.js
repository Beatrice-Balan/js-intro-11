...
// option 1
const a4 = [...a1, ...a2, ...a3].sort((a, b) => b - a);

// option 2
const a5 = a1.concat(a2, a3).sort((a, b) => b - a);
...
THEN:
-Output both arrays
–Then, create a new array that will multiply the numbers of the same indexes 
from the first 2 arrays 
...
for(let i = 0; i < arr1.length; i++) { // i = 0, 1, 2, 3, 4
    ...
    // or use push(): arr3.push(arr1[i] * arr2[i]);
}
