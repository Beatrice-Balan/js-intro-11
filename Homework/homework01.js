...
console.log(`My height is ${myHeight}cm.`);
console.log(`My weight is ${myWeight}kg.`);
...
console.log(`The area of the square = ${4 * side}`);
console.log(`The perimeter of the square = ${side * side}`);
...
console.log(
    `User who joined this program is ${person.firstName} ${person.lastName}. ${person.firstName}'s age is ${person.age}.
${person.firstName}'s email address is ${person.emailAddress}, phone number is 
${person.phoneNumber}, and address is ${person.address}.`);
